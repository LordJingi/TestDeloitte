		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "S4HANA UI Extension2",
									"targetURL": "#S4HANAUIExtension2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"S4HANAUIExtension2-display": {
								"semanticObject": "S4HANAUIExtension2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.sapui52",
									"url": sap.ui.require.toUrl("sap/btp/sapui52")
								}
							}
						}
					}
